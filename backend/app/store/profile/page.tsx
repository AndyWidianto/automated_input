        ...
        <div className="grid grid-cols-1 gap-8">
          ...
          <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div className="bg-slate-50/50 px-8 py-4 flex justify-end border-t border-slate-100">
              <button onClick={handleSubmit} className="bg-slate-900 text-white px-6 py-2.5 rounded-xl text-sm font-bold hover:bg-slate-800 transition-all active:scale-95 shadow-lg shadow-slate-200">
