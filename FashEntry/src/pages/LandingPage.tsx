                    ...
                    <div className="mx-auto max-w-4xl py-20 sm:py-24 lg:py-30">
                        <div className="text-center">
                            ...
                            <div className="mt-10 flex items-center justify-center gap-x-6">
                                <NavLink to="/signup" className="rounded-full bg-emerald-600 px-8 py-3.5 text-sm font-semibold text-white shadow-sm hover:bg-emerald-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-600">
                                    Try it Free
                                </NavLink>
                                <NavLink to="/learn-more" className="text-sm font-semibold leading-6 text-gray-950 flex items-center gap-x-1">
