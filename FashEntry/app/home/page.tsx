...
import { Zap, Clock, BrainCircuit, ShieldCheck, Globe, LayoutGrid } from 'lucide-react';
...
const features: Feature[] = [
    {
        ...
        description: 'Improve image quality automatically by increasing clarity and resolution for better visual results.',
        icon: BrainCircuit,
    },
    {
        name: 'Image to Document',
        description: 'Convert images into editable text or document formats such as TXT and DOC with ease.',
        icon: LayoutGrid,
    },
    {
        name: 'Bulk Excel Processing',
        description: 'Automate repetitive tasks using Excel data in bulk to save time and reduce manual work.',
        icon: Zap,
    },
    {
        name: 'Easy-to-Use Extensions',
        description: 'Access productivity-focused extensions through a simple and user-friendly interface.',
        icon: ShieldCheck,
    },
    {
        name: 'Time-Saving Automation',
        description: 'Reduce repetitive manual tasks with automation tools designed to improve workflow efficiency.',
        icon: Globe,
    },
    {
        name: 'Continuous Development',
        description: 'New automation features and extensions are continuously being developed to expand functionality.',
        icon: Clock,
    },
    // {
                        ...
                        <div className="mx-auto max-w-3xl text-center">
                            <div className="mb-8 flex justify-center">
                                <span className="rounded-full px-3 py-1 text-sm font-medium leading-6 text-emerald-600 ring-1 ring-inset ring-emerald-600/10 bg-emerald-50">
                                    New: Smarter Automation Features Available
                                </span>
                            </div>
                            ...
                            <p className="mt-8 text-lg leading-8 text-slate-600 max-w-2xl mx-auto">
                                Simplify repetitive tasks with powerful automation tools — from image enhancement,
                                image-to-document conversion, and bulk Excel processing to many more smart extensions
                                designed to improve your workflow productivity.
                            </p>
